...
export const zh: Dictionary = {
  ...
  "SELECTED EXPERIENCE": "项目案例", "Complex environments, delivered with care.": "复杂项目，可靠交付。", "Selected references from JOTO materials. Scope statements remain deliberately concise pending the next client-approval review.": "以下案例根据已获客户授权的公开信息整理。",
  ...
  "START A CONVERSATION": "联系 JOTO", "Bring us the environment you need to improve.": "告诉我们你希望改善的 IT 环境。", "Tell us about your locations, priorities and timeline. We will help shape a practical next step.": "请提供项目地点、优先事项和时间计划，我们会据此提出下一步建议。", "© JOTO TECH. All rights reserved.": "© JOTO TECH。保留所有权利。",
