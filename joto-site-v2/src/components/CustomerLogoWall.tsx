    ...
    >
      {failed ? (
        ...
        <img
          ...
          className={`${logoScaleClasses[scale]} w-auto object-contain opacity-70 grayscale brightness-50 transition-[filter,opacity,transform] duration-300 group-hover:scale-[1.02] group-hover:opacity-100 group-hover:grayscale-0 group-hover:brightness-75`}
    ...
    >
      ...
      <div className="space-y-3">
        {customerLogoRows.map((logos, rowIndex) => (
          <div
            aria-label={`${t("Customer logos row")} ${rowIndex + 1}`}
